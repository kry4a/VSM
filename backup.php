...
class ControllerExtensionModuleOCFilter extends Controller {
  ...
  public function index($settings = array()) {
    ...
    $this->document->addStyle('catalog/view/theme/default/css/ocfilter.css');
  ...
  private function getOCFilterOptions() {
    ...
    # Serial status filtering
    $options['serial'] = array(
      'option_id'   => 'l',
      'name'        => false,
      'description' => 'Серийный товар',
      'type'        => 'checkbox',
      'values'      => array(
        array(
          'value_id'    => '1',
